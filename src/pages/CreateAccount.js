      ...
      <div className="flex flex-col justify-center items-center h-full ">
        <div class="bg-white shadow-md rounded mb-4 w-3/5 h-auto flex z-20">
          <div class="flex flex-col items-start w-1/2 p-12 h-full justify-items-center">
            <h1 className="font-bold text-2xl text-pink-dark mb-10">
              Crear nueva cuenta
            </h1>
            <form
            ...
            >
              ...
              <input
                className={`w-full border rounded px-3 py-1 border-border-gray mb-5 ${
              ...
              <input
                className="w-full border rounded px-3 py-1 border-border-gray mb-2"
                type="password"
                value={password}
              ...
              <a className="w-full flex justify-end text-border-gray mb-10">
              ...
              <button
                className="bg-pink-dark px-6 py-2 rounded text-white"
                type="submit"
              >
                Crear cuenta
              </button>
          ...
          <div className="w-1/2 bg-pink-light relative">
            ...
            <div className="w-full aboslute bottom-0 left-0">
              <img
                src={wave1}
                className="absolute -z-0 bottom-0 w-full h-1/4"
              />
              <img
                src={wave2}
                className="absolute -z-0 bottom-0 w-full h-1/4"
